package com.lion.itransfer.ui.actionbutton;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonColorNormal = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorNormal, R.color.button_normal);
        mAddButtonColorPressed = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorPressed, R.color.button_pressed);
