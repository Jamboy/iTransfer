package com.lion.itransfer.ui.fragment;
...
import com.lion.itransfer.ui.TestRecyclerViewAdapter;
import com.lion.itransfer.ui.file.EventHandler;
import com.lion.itransfer.ui.file.FileManager;


/**
 * Created by florentchampigny on 24/04/15.
 */
public class ChoseFileToComputerRecyclerViewFragment extends Fragment {
    ...
    public static ChoseFileToComputerRecyclerViewFragment newInstance() {
        return new ChoseFileToComputerRecyclerViewFragment();
    }
        ...
        tAdapter.setOnItemClickListener(new TestRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (file.isDirectory()) {
                    ...
                    Intent intent = new Intent(context, SendToComputerActivity.class);
