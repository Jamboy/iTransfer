...
package com.lion.itransfer.ftpserver.ppareit.ppareit.swiftp.server;
...
import com.lion.itransfer.ftpserver.ppareit.ppareit.swiftp.Defaults;
import com.lion.itransfer.application.ITransferApp;
import com.lion.itransfer.ftpserver.ppareit.ppareit.swiftp.FsService;
import com.lion.itransfer.ftpserver.ppareit.ppareit.swiftp.FsSettings;
...
public class SessionThread extends Thread {
    ...
    public void run() {
        ...
        if (sendWelcomeBanner) {
            writeString("220 SwiFTP " + ITransferApp.getVersion() + " ready\r\n");
        }
